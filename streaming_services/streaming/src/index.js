...
if (!process.env.MEDIA_BASE_DIR_MOVIES || !process.env.MEDIA_BASE_DIR_TVSHOWS){
    throw new Error("Please make sure volumes are specified correctly in docker compose (mnt/media/...)")
}
